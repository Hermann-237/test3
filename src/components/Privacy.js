...
const Privacy = () => {
    return (
        <div className="container">
            ...
            <h2>Contacting us</h2>
            <p>If you would like to contact us to understand more about this Policy or wish to contact us concerning any matter relating to it, you may send an email to <a href="mailto:simplecyto@contact.com">simplecyto@contact.com</a> </p>
            <p>This document was last updated on March 17, 2020</p>
